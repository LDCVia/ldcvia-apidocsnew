define({ "api": [
  ...
  {
    "type": "post",
    "url": "/deleteattachments/:db/:collection/:unid",
    "title": "Delete Attachments",
    "description": "<p>Deletes an array of file attachments from a document</p>",
    "name": "deleteattachments",
    "version": "1.0.20170301",
    "group": "Attachment",
    "success": {
      "fields": {
        "Success 200": [
  ...
  {
    "type": "post",
    "url": "/attachment/:db/:collection/:unid",
  ...
  {
    "type": "post",
    "url": "/search/:db/:collection",
    "title": "Search Collection Data",
    "description": "<p>To perform a search against a collection, you can submit queries to be run against one or more fields or against the entire collection using full text.</p> <p>To use a full text query, the database must be indexed which can be enabled in DB Viewer - Database Settings or using the <a href=\"#api-Database-SetDatabaseDetails\">Set Database Details</a> API.</p> <p>Search queries are built up using an array of JSON objects. You can search for exact matches in a field, fields that contain text, or date and number ranges. You can add as many parameters to a search as are required to get the set of documents that you need, and then use the URL parameters count and start to page through the results. In this way you can effectively create the equivalent of Notes views of data.</p> <p>Full Text and field based queries can be mixed together in the same request if required.</p> <p>Keywords that you can use to search for data include:</p> <p>&quot;contains&quot;\tused to search a field to see if it contains the value being searched for</p> <p>&quot;equals&quot;\tused to find a field that is an exact match for the value being searched for</p> <p>&quot;exists&quot; used to find documents on which a field either exists or does not exist</p> <p>&quot;$gte&quot;\tused when searching for dates and numbers greater than or equal to the value entered. For dates the full ISO 8601 format should be used</p> <p>&quot;$lte&quot;\tused when searching for dates and numbers less than or equal to the value entered. For dates the full ISO 8601 format should be used</p> <p>When you enter multiple criteria, they are applied together with an OR style join by default, change this to AND using the URL parameter “…&amp;join=and”.</p> <p>You can also perform a regular expression based search that allows you to perform case insensitive searches or more complex queries.</p> <p>Examples of different search JSON objects can be seen below.</p>",
    "name": "searchcollectiondata",
    "version": "1.0.20170101",
    "group": "Collection",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "responses",
            "description": "<p>A URL query string parameter, either &quot;all&quot; or &quot;immediate&quot; to populate a field on each document in results with &quot;__responses&quot; array of response details</p>"
          },
          {
            "group": "Parameter",
            "type": "object",
      ...
      "examples": [
        ...
        {
          "title": "Exists Filters:",
          "content": "//Return only documents that have the specified field present regardless of value\n//OR return only documents that do not have the specified present on them\n{\n \"filters\": [\n {\n   \"operator\": \"exists\",\n   \"field\": \"myfield\",\n   \"value\": true\n }\n ]\n}",
          "type": "json"
        },
        {
  ...
  },
  {
    "type": "post",
    "url": "/stampall/:db",
    "title": "Stamp Document Collection",
    "description": "<p>Given a database, and an array of __unid values, stamp a value onto each document</p>",
    "name": "stampall",
    "version": "1.0.20170101",
    "group": "Collection",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "arrayoffields",
            "description": "<p>The list of fields and values that you want to stamp onto the documents</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "all",
            "description": "<p>An optional URL query string parameter when added, an extra boolean field &quot;__iseditable&quot; which defines whether the current user is allowed to edit the document. This can have a significant effect on performance</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "get",
    "url": "/recipes/:recipe",
    "title": "Get Details about a Recipe",
    "description": "<p>Get the full details of a recipe (oh and the release notes associated with the recipe)</p>",
    "name": "getrecipe",
