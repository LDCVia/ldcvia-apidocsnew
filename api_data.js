define({ "api": [
  ...
  },
  {
    ...
    "url": "/login",
    "title": "Login (API Key)",
    "description": "<p>Given a username and password, this method returns the API key for the user which can then be used in future requests as an HTTP Header</p>",
    "name": "loginapikey",
    "version": "1.0.20160607",
